...
func (c *customerServiceClient) GetCustomer(ctx context.Context, in *CustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pbcustomer.CustomerService/GetCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerService_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbcustomer.CustomerService/GetCustomer",
	}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pbcustomer.CustomerService",
